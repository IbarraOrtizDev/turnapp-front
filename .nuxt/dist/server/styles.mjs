...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.DuzitRXy.mjs').then(interopDefault),
  ...
  "layouts/auth.vue": () => import('./_nuxt/auth-styles.BjyNhhyW.mjs').then(interopDefault),
  "layouts/auth.vue?vue&type=style&index=0&scoped=d0a57bbc&lang.css": () => import('./_nuxt/auth-styles.BjyNhhyW.mjs').then(interopDefault)
}